 ...
 * some findings are legitimately untranslated (brand name, `CPU`/`RAM`). The
 * ceiling stops it getting worse; lower it as strings are migrated to `t()`.
 */
const RAW_TEXT_CEILING = 13;
