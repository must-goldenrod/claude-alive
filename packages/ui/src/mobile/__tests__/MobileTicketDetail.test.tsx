...
describe('MobileTicketDetail — desktop parity', () => {
  ...
  it('shows the run information the desktop modal shows', () => {
    render(<MobileTicketDetail {...props(base({ model: 'claude-opus-5-5', effort: 'high', preset: 'deep' } as never))} />);
    expect(screen.getByText('Opus 5.5 (claude-opus-5-5)')).toBeInTheDocument();
